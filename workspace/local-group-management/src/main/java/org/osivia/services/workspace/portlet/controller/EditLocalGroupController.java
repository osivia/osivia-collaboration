...
/**
 * Edit local group portlet controller.
 * 
...
public class EditLocalGroupController {
     ...
     * Constructor.
     */
    public EditLocalGroupController() {
        super();
    }
    ...
    public void submit(ActionRequest request, ActionResponse response, @Validated @ModelAttribute("form") LocalGroupForm form, BindingResult result,
        ...
        if (result.hasErrors()) {
            ...
            this.service.edit(portalControllerContext, form);
     ...
     */
    @ModelAttribute("form")
    public LocalGroupForm getForm(PortletRequest request, PortletResponse response, @RequestParam("id") String id) throws PortletException {
        // Portal controller context
        PortalControllerContext portalControllerContext = new PortalControllerContext(this.portletContext, request, response);

        return this.service.getForm(portalControllerContext, id);
    }
