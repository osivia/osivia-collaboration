...
public class WorkspaceEditionController extends CMSPortlet implements PortletConfigAware, PortletContextAware {
    ...
    public void createTask(ActionRequest request, ActionResponse response, @ModelAttribute("editionForm") WorkspaceEditionForm form)
            throws PortletException {
        // Portal controller context
        PortalControllerContext portalControllerContext = new PortalControllerContext(this.portletContext, request, response);
    ...
    /**
     * Get task creation URL model attribute.
     * 
     * @param request portlet request
     * @param response portlet response
     * @param form workspace edition form model attribute
     ...
     * @throws PortletException
     */
    @ModelAttribute("taskCreationUrl")
    public String getTaskCreationUrl(PortletRequest request, PortletResponse response, @ModelAttribute("editionForm") WorkspaceEditionForm form)
            throws PortletException {
        // Portal controller context
        PortalControllerContext portalControllerContext = new PortalControllerContext(this.portletContext, request, response);

        return this.service.getTaskCreationUrl(portalControllerContext, form);
    }
