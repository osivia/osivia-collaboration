    ...
    <form:form action="${submitUrl}" method="post" modelAttribute="invitationEditionForm" cssClass="form-horizontal" role="form">
        <fieldset>
            ...
            <div class="form-group">
                ...
                <div class="col-sm-9 col-lg-10">
                    <p class="form-control-static">
                        ...
                        <button type="submit" name="resend" class="btn btn-link btn-xs">
                            <span><op:translate key="WORKSPACE_MEMBER_MANAGEMENT_INVITATION_RESEND" /></span>
                        </button>
                    </p>
                </div>
            </div>
            ...
            <div class="form-group">
                ...
                <form:label path="invitation.message" cssClass="control-label col-sm-3 col-lg-2"><op:translate key="WORKSPACE_MEMBER_MANAGEMENT_INVITATION_MESSAGE" /></form:label>
                <div class="col-sm-9 col-lg-10">
                    <form:textarea path="invitation.message" cssClass="form-control" placeholder="${placeholder}" />
                    <p class="help-block"><op:translate key="WORKSPACE_MEMBER_MANAGEMENT_INVITATION_EDITION_MESSAGE_HELP" /></p>
                </div>
            </div>
            ...
            <div class="form-group">
                <div class="col-sm-offset-3 col-sm-9 col-lg-offset-2 col-lg-10">
                    ...
                    <p class="help-block"><op:translate key="WORKSPACE_MEMBER_MANAGEMENT_INVITATION_EDITION_SAVE_HELP" /></p>
                </div>
            </div>
        </fieldset>
    </form:form>
