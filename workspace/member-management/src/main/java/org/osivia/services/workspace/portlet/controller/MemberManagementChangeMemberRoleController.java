...
public class MemberManagementChangeMemberRoleController {
    ...
    public String view(RenderRequest request, RenderResponse response) throws PortletException {
        ...
        return "change-member-role/view";
    }
    ...
    public void save(ActionRequest request, ActionResponse response, @ModelAttribute("options") MemberManagementOptions options,
            @Validated @ModelAttribute("changeRoleForm") ChangeMemberRoleForm form, BindingResult result, SessionStatus sessionStatus) throws PortletException {
        ...
        if (result.hasErrors()) {
            ...
            this.service.updateMemberRole(portalControllerContext, options, form);
    ...
    public ChangeMemberRoleForm getForm(PortletRequest request, PortletResponse response, @RequestParam(name = "identifiers", required = false) String[] identifiers)
            throws PortletException {
        // Portal controller context
        PortalControllerContext portalControllerContext = new PortalControllerContext(this.portletContext, request, response);

        return this.service.getChangeMemberRoleForm(portalControllerContext, identifiers);
    }
