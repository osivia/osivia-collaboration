package org.osivia.services.pins.plugin.configuration;
...
/**
 * Pins plugin configuration
 * @author jbarberet
 *
 */
@Configuration
@ComponentScan(basePackages="org.osivia.services.pins.plugin")
public class PinsPluginConfiguration {
     ...
     * Constructor.
     */
	public PinsPluginConfiguration() {
		super();
	}
