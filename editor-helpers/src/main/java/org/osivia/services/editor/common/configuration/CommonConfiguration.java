package org.osivia.services.editor.common.configuration;
 ...
 */
public abstract class CommonConfiguration extends CMSPortlet implements PortletConfigAware {
    ...
    public InternalResourceViewResolver getViewResolver() {
        ...
        viewResolver.setPrefix("/WEB-INF/jsp/" + this.getSlug() + "/");
