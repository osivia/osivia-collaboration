    ...
    $JQry(".forum textarea[data-editor=message]").each(function(index, element) {
        ...
        if (editorUrl === undefined) {
            ...
            tinymce.init({
                ...
                branding: false,
                menubar: false,
                toolbar: "undo redo | bold italic underline strikethrough | alignleft aligncenter alignright alignjustify | bullist numlist | blockquote | osivia-link",
                statusbar: false,
                ...
                contextmenu: false,
                content_css: ["/osivia-portal-custom-web-assets/css/bootstrap.min.css", "/osivia-portal-custom-web-assets/css/osivia.min.css", "/osivia-services-forum/css/forum-tinymce.min.css"],
                height: "250",
