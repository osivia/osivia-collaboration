package org.osivia.services.calendar.view.portlet.utils;
...
public enum PeriodTypes {
    ...
    /** Day. */
    DAY("day", Calendar.DAY_OF_MONTH, "view-scheduler", false),
    /** Week. */
    WEEK("week", Calendar.WEEK_OF_YEAR, "view-scheduler", false),
    /** Month. */
    MONTH("month", Calendar.MONTH, "view-scheduler", false),
    /** Planning. */
    PLANNING("planning", -1, "/view-planning", true);
