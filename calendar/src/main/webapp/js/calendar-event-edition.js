$JQry(function() {
	$JQry(".calendar.calendar-event-edition textarea[name=description]").each(function(index, element) {
        ...
        if (tinymce.get(id)) {
            ...
            tinymce.init({
                ...
                content_css: ["/osivia-portal-custom-web-assets/css/bootstrap/bootstrap.min.css", "/osivia-services-calendar/css/calendar-edition.min.css"],
