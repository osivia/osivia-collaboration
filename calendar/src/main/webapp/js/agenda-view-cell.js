function printCell()
{
    ...
    scheduler.attachEvent("onTemplatesReady", function(){
        scheduler.templates.event_text=function(start, end, event){
            return "<a href=\"javascript:\" onclick=\"openModal(this)\" class=\"event_title no-ajax-link\" data-load-url=\"" + event.preview_url + "\" data-load-callback-function=\"calendarPreviewLoadCallback\" data-size=\"small\">" + event.text + "</a>";
        };
